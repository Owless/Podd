          ...
          <div className="container mx-auto px-4 py-6 pb-24">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="animate-pulse space-y-6">
                ...
                <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-white/20 dark:border-gray-700/50">
                  <div className="flex items-center space-x-4 mb-6">
                    <div className="w-16 h-16 bg-gradient-to-br from-purple-400 to-purple-600 rounded-2xl animate-pulse"></div>
                  ...
                  <div className="space-y-4">
                    <div className="h-20 bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-900 dark:to-purple-800 rounded-xl animate-pulse"></div>
                    <div className="h-16 bg-gray-100 dark:bg-gray-700 rounded-xl animate-pulse"></div>
                    <div className="h-20 bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900 dark:to-blue-900 rounded-xl animate-pulse"></div>
                  </div>
                </div>
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-700/50 p-4 sm:p-6 rounded-xl border border-gray-200/50 dark:border-gray-600/50">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400">отслеживается</div>
                      </div>
                    </div>
                  </div>
